...
If you're using PrgEnv-intel with OpenMP, please see [(https://bluewaters.ncsa.illinois.edu/intel-compiler](https://bluewaters.ncsa.illinois.edu/intel-compiler) for specific recommendations regarding aprun and setting KMP_AFFINITY appropriately.
